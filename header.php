...
<html lang="ru">
    ...
    <!-- Google Tag Manager -->
        <script>
            ...
            (window,document,'script','dataLayer','GTM-T9FS3R2');
        </script>
    <!-- End Google Tag Manager -->
    <body>
        <!-- Google Tag Manager (noscript) -->
            <noscript>
                <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T9FS3R2" height="0" width="0" style="display:none;visibility:hidden"></iframe>
            </noscript>
